...
import shx.kitsune.utils.CompositeIterator;
...
public final class ScriptMemoryManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    public ScriptClassLoader getClassLoader(ScriptEngine loader, File file, String fullClassName, FileScriptMemoryJavaObject source) throws ScriptException, MalformedURLException {
