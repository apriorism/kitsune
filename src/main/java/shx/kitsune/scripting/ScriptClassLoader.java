...
public final class ScriptClassLoader extends URLClassLoader {
    private final ScriptEngine loader;
    ...
    ScriptClassLoader(ScriptEngine loader, Map<String, ClassScriptMemoryJavaObject> mapNameToBytes, ClassLoader parent, File file, String fullClassName, FileScriptMemoryJavaObject source) throws ScriptException, MalformedURLException {
